    ...
    */
	public function obtenerTodos()
	{
		try
		{
			...
			$sentenciaSQL = $this->conexion->prepare("SELECT id,nombre,correo,contrasena,institucion,tipo FROM Usuario");
...
/**
    ...
    public function obtenerUno($id)
	{
		...
		{ 
			...
			$sentenciaSQL = $this->conexion->prepare("SELECT id,nombre,correo,institucion,tipo FROM usuario WHERE id=?"); 
			//Se ejecuta la sentencia sql con los parametros dentro del arreglo 
    ...
    public function agregara(Usuario $obj)
	{
        $clave=0;
		try 
		{
